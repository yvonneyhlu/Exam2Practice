...
def run_test_practice_problem2a():
    ...
    print('Test 1 expected: ' + str(expected))
    ...
    # test 3
    expected = [3, 6, 9, 11, 13]
    actual = practice_problem2a([3, 6, 9, 11, 13], 0)
    print('Test 3 expected: ' + str(expected))
    print('actual' + str(actual))

    # test 4
    expected = [10, 20, 110, 1010, 10010]
    actual = practice_problem2a([0, 10, 100, 1000, 10000], 10)
    print('Test 1 expected: ' + str(expected))
    print('actual' + str(actual))
